...
function action (keys, playerName) {
  switch(keys[0]) {
  case "hack-jamHash": {
    return activateHack(keys[1], playerName, "jamHash", true, 5, 60000)
  }
  case "hack-jamLeet": {
    return activateHack(keys[1], playerName, "jamLeet", true, 5, 60000)
  }
  case "hack-jamMirror": {
    return activateHack(keys[1], playerName, "jamMirror", true, 5, 60000)
  }
  case "hack-jamMix": {
    return activateHack(keys[1], playerName, "jamMix", true, 5, 60000)
  }
  case "hack-jamFaun": {
    return activateHack(keys[1], playerName, "jamFaun", true, 5, 60000)
  }
  case "hack-jamSmear": {
    return activateHack(keys[1], playerName, "jamSmear", true, 5, 60000)
  }
  case "hack-spy": {
