...
var secretStrings = [
  ...
  { secret: "a déclenché la crise de Wall Street en revendant des actions contre des images de chatons larmoyant", hint: "Chatons" },
  { secret: "a fait exploser le popcorn qui a provoqué l’éruption du Vésuve anéantissant Pompéi", hint: "Pompéi" },
  { secret: "a penché la Tour de Pise pour aligner l’axe de la Terre avec le Soleil", hint: "Tour de Pise" },
  { secret: "a détourné une soucoupe volante sur Google Earth", hint: "Google" },
  ...
  { secret: "a provoqué la fin de l’ère Secondaire en enfermant les dinosaures dans les boîtes de Dinosaurus", hint: "Dinosaures" },
  { secret: "a libéré le monstre du Loch Ness qui a provoqué le Tsunami près de Fukushima", hint: "Tsunami" },
  ...
  { secret: "a inséré une bulle contenant le virus de la peste dans les internets de l’an 2 000", hint: "Virus" },
