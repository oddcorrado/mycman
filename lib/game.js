...
var secretStrings = [
  ...
  "nous avons la main mise sur la trésorerie du KGB",
  "nous avons la main mise sur la trésorerie de la CIA",
  "nous avons la main mise sur la trésorerie du MOSSAD",
  "nous avons racheté au marché noir la moitié des missiles de l'armée russe",
  "nous avons racheté au marché noir l'ensemble de l'aviation russe",
  "nous avons racheté sur eBay l'ensemble des fusils de l'armée russe",
  "nous avons racheté au marché noir la moitié des missiles de l'armée nord coréenne",
  "nous avons racheté au marché noir l'ensemble de l'aviation nord coréenne",
  "nous avons racheté sur eBay l'ensemble des fusils de l'armée nord coréenne",
  "nous avons racheté au marché noir la moitié des missiles de l'armée américaine",
  "nous avons racheté au marché noir l'ensemble de l'aviation américaine",
  "nous avons racheté sur eBay l'ensemble des fusils de l'armée américaine",
  "nous avons retrouvé et décongelé le cerveau de Newton",
  "nous avons resynthétisé l'ADN de Newton",
  "nous avons modélisé sur une puce la conscience de Newton",
  "nous avons retrouvé et décongelé le cerveau de Einstein",
  "nous avons resynthétisé l'ADN de Einstein",
  "nous avons modélisé sur une puce la conscience de Einstein",
  "nous avons retrouvé et décongelé le cerveau de Vinci",
  "nous avons resynthétisé l'ADN de Vinci",
  "nous avons modélisé sur une puce la conscience de Vinci",
]
/* var secretStrings = [
...
function decisionStop(decisions) {
  ...
  Object.keys(decisions).forEach(name => {
    ...
    if((decisions[name].y > 75) && (decisions[name].y < 325)) {
