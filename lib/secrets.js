const secretStrings = [
  { secret: "Excalibur", hint: "Excalibur", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Graal", hint: "Le Graal", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le fil d'Ariane", hint: "Le fil d'Ariane", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Durandal", hint: "Durandal", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Boîte de Pandore", hint: "La Boîte de Pandore", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "L'Epée de Damoclès", hint: "L'Epée de Damoclès", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Mjöllnir", hint: "Mjöllnir", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Pomme de Discorde", hint: "La Pomme de Discorde", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "L'Arche d'Alliance", hint: "L'Arche d'Alliance", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Hollandais Volant", hint: "Le Hollandais Volant", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Cheval de Troie", hint: "Le Cheval de Troie", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Les Sandales Ailées", hint: "Les Sandales Ailées", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Les Fleurs de Lotos", hint: "Les Fleurs de Lotos", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Corne d'Abondance", hint: "La Corne d'Abondance", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Pierre Philosophale", hint: "La Pierre Philosophale", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Heaume d'Hades", hint: "Le Heaume d'Hades", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Couronne d'épines", hint: "La Couronne d'épines", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le baton de Moïse", hint: "Le baton de Moïse", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Caducée", hint: "Le Caducée", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Lance de Longinus", hint: "La Lance de Longinus", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Les bottes de 7 lieues", hint: "Les bottes de 7 lieues", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "L'Ankh", hint: "L'Ankh", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Shive Kundala", hint: "Shive Kundala", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "L'arche de Noé", hint: "L'arche de Noé", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Neshmet", hint: "Neshmet", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La barque de Charon", hint: "La barque de Charon", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Livre des Morts", hint: "Le Livre des Morts", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Nécronomicon", hint: "Le Nécronomicon", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Lampe d'Aladin", hint: "La Lampe d'Aladin", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Golem", hint: "Le Golem", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Fruit Interdit", hint: "Le Fruit Interdit", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Sable du Marchand", hint: "Le Sable du Marchand", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La flûte de Pan", hint: "La flûte de Pan", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Harpe de David", hint: "La Harpe de David", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Lyre d'Appolon", hint: "La Lyre d'Appolon", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Tête de Méduse", hint: "La Tête de Méduse", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Le Mirroir Magique", hint: "Le Mirroir Magique", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Tour de Babel", hint: "La Tour de Babel", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Poupée Vaudou", hint: "La Poupée Vaudou", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Yaka No Kagami", hint: "Yaka No Kagami", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "Gleipnir", hint: "Gleipnir", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
  { secret: "La Toison d'Or", hint: "La Toison d'Or", cooldown:0, cooldownPeriod:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false, pos:10},
...
secretStrings.find(s => s.secret === 'Excalibur').votePower = function(votes) {
  console.log('Excalibur', votes)
...
secretStrings.find(s => s.secret === 'Mjöllnir').votePower = function(votes) {
  console.log('Mjöllnir', votes)
  console.log('this is ', this.secret, this.cooldown, this.targets)
  this.targets.forEach(target => {
    let voter = votes.find(v => v.voter === target)
    if(voter) {
...
secretStrings.find(s => s.secret === 'Durandal').votePower = function(votes) {
  console.log('Durandal', votes)
  console.log('this is ', this.secret, this.cooldown, this.targets)
  this.targets.forEach(target => {
    let voter = votes.find(v => v.voter === target)
    if(voter) {
