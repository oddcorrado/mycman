const secretStrings = [
  ...
  { secret: "Excalibur", hint: "Excalibur", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Graal", hint: "Le Graal", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le fil d'Ariane", hint: "Le fil d'Ariane", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Durandal", hint: "Durandal", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Boîte de Pandore", hint: "La Boîte de Pandore", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "L'Epée de Damoclès", hint: "L'Epée de Damoclès", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Mjöllnir", hint: "Mjöllnir", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Pomme de Discorde", hint: "La Pomme de Discorde", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "L'Arche d'Alliance", hint: "L'Arche d'Alliance", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Hollandais Volant", hint: "Le Hollandais Volant", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Cheval de Troie", hint: "Le Cheval de Troie", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Les Sandales Ailées", hint: "Les Sandales Ailées", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Les Fleurs de Lotos", hint: "Les Fleurs de Lotos", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Corne d'Abondance", hint: "La Corne d'Abondance", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Pierre Philosophale", hint: "La Pierre Philosophale", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Heaume d'Hades", hint: "Le Heaume d'Hades", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Couronne d'épines", hint: "La Couronne d'épines", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le baton de Moïse", hint: "Le baton de Moïse", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Caducée", hint: "Le Caducée", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Lance de Longinus", hint: "La Lance de Longinus", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Les bottes de 7 lieues", hint: "Les bottes de 7 lieues", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "L'Ankh", hint: "L'Ankh", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Shive Kundala", hint: "Shive Kundala", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "L'arche de Noé", hint: "L'arche de Noé", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Neshmet", hint: "Neshmet", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La barque de Charon", hint: "La barque de Charon", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Livre des Morts", hint: "Le Livre des Morts", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Nécronomicon", hint: "Le Nécronomicon", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Lampe d'Aladin", hint: "La Lampe d'Aladin", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Golem", hint: "Le Golem", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Fruit Interdit", hint: "Le Fruit Interdit", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Sable du Marchand", hint: "Le Sable du Marchand", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La flûte de Pan", hint: "La flûte de Pan", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Harpe de David", hint: "La Harpe de David", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Lyre d'Appolon", hint: "La Lyre d'Appolon", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Tête de Méduse", hint: "La Tête de Méduse", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Le Mirroir Magique", hint: "Le Mirroir Magique", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Tour de Babel", hint: "La Tour de Babel", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Poupée Vaudou", hint: "La Poupée Vaudou", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Yaka No Kagami", hint: "Yaka No Kagami", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "Gleipnir", hint: "Gleipnir", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
  { secret: "La Toison d'Or", hint: "La Toison d'Or", cooldown:2, inUse:false, help:'powerup texte', targetMax:1, targets:[], available:false},
