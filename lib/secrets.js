...
const secretStrings = [
  ...
  // MP LOG
  { secret: "espion A", type: "spy", short:'espion', hint: "espion A", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "espion B", type: "spy", short:'espion', hint: "espion B", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "espion C", type: "spy", short:'espion', hint: "espion C", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "espion D", type: "spy", short:'espion', hint: "espion D", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "espion E", type: "spy", short:'espion', hint: "espion E", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "espion F", type: "spy", short:'espion', hint: "espion F", cooldown:0, cooldownPeriod:0, inUse:false, help:'Récupère tous les messages', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  ...
  { secret: "L\'Epée De Damoclès", type: "malus", short:'-1', hint: "L\'Epée De Damoclès", cooldown:0, cooldownPeriod:1, inUse:false, help:'Donne -1 au vote à un autre joueur', log:'L\'Epée De Damoclès donne -1 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
...
// JAM
// *******************************************************
secretStrings.find(s => s.secret === 'espion A').lifecycleActivate = function() {
  return log.messagesAll()
}

secretStrings.find(s => s.secret === 'espion B').lifecycleActivate = function() {
  return log.messagesAll()
}

secretStrings.find(s => s.secret === 'espion C').lifecycleActivate = function() {
  return log.messagesAll()
}

secretStrings.find(s => s.secret === 'espion D').lifecycleActivate = function() {
  return log.messagesAll()
}

secretStrings.find(s => s.secret === 'espion E').lifecycleActivate = function() {
  return log.messagesAll()
}

secretStrings.find(s => s.secret === 'espion F').lifecycleActivate = function() {
  return log.messagesAll()
}
// *******************************************************
// BOMBS
