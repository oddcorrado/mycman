...
const secretStrings = [
  // MP JAM
  { secret: "Jam1", type: "jam", short:'brouilleur', hint: "Jam1", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Jam2", type: "jam", short:'brouilleur', hint: "Jam2", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Jam3", type: "jam", short:'brouilleur', hint: "Jam3", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Jam4", type: "jam", short:'brouilleur', hint: "Jam4", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Jam5", type: "jam", short:'brouilleur', hint: "Jam5", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Jam6", type: "jam", short:'brouilleur', hint: "Jam6", cooldown:0, cooldownPeriod:0, inUse:false, help:'Brouille la messagerie', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},

  // STRONG
  { secret: "Excalibur", type: "bonus", short:'+3', hint: "Excalibur", cooldown:0, cooldownPeriod:3, inUse:false, help:'Donne +3 au vote à un autre joueur', log:'Donne +3 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Durandal", type: "bonus", short:'+2', hint: "Durandal", cooldown:0, cooldownPeriod:2, inUse:false, help:'Donne +2 au vote à un autre joueur', log:'Donne +3 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Joyeuse", type: "bonus", short:'+1', hint: "Joyeuse", cooldown:0, cooldownPeriod:1, inUse:false, help:'Donne +1 au vote à un autre joueur', log:'Donne +3 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Almace", type: "bonus", short:'+2', hint: "Almace", cooldown:0, cooldownPeriod:2, inUse:false, help:'Donne +2 au vote à un autre joueur', log:'Donne +2 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Curtana", type: "bonus", short:'+1', hint: "Curtana", cooldown:0, cooldownPeriod:1, inUse:false, help:'Donne +1 au vote à un autre joueur', log:'Donne +1 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Le Baton De Circé", type: "malus", short:'-3', hint: "Le Baton De Circé", cooldown:0, cooldownPeriod:3, inUse:false, help:'Donne -3 au vote à un autre joueur', log:'Donne -3 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "La Tunique De Nessos", type: "malus", short:'-3', hint: "La Tunique De Nessos", cooldown:0, cooldownPeriod:3, inUse:false, help:'Donne -3 au vote à un autre joueur', log:'Donne -3 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Les Ailes D\'Icare", type: "malus", short:'-2', hint: "Les Ailes D\'Icare", cooldown:0, cooldownPeriod:2, inUse:false, help:'Donne -2 au vote à un autre joueur', log:'Donne -2 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "L\'Epée De Damoclès", type: "malus", short:'-1', hint: "L\'Epée De Damoclès", cooldown:0, cooldownPeriod:1, inUse:false, help:'Donne -1 au vote à un autre joueur', log:'Donne -1 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},
  { secret: "Le Thyrse", type: "malus", short:'-1', hint: "Le Thyrse", cooldown:0, cooldownPeriod:2, inUse:false, help:'Donne -1 au vote à un autre joueur', log:'Donne -1 au vote à un autre joueur', targetMax:1, targetNoSelf:true,  targets:[], available:false, pos:10},

  // BOMBS
  { secret: "Little Boy", type: "bomb", short:'révèle 0', hint: "Little Boy", cooldown:0, cooldownPeriod:100, inUse:false, help:'Les joueurs ayant 0 votes sont révélés', log:'log text', targetMax:0, targetNoSelf:false,  targets:[], available:false, pos:10},
  { secret: "Fat Man", type: "bomb", short:'révèle 1', hint: "Fat Man", cooldown:0, cooldownPeriod:100, inUse:false, help:'Les joueurs ayant 1 vote sont révélés', log:'log text', targetMax:0, targetNoSelf:false,  targets:[], available:false, pos:10},
  { secret: "Czar Bomba", type: "bomb", short:'révèle tous', hint: "Czar Bomba", cooldown:0, cooldownPeriod:100, inUse:false, help:'Tous les joueurs sont révélés', log:'log text', targetMax:0, targetNoSelf:false,  targets:[], available:false, pos:10},
  { secret: "Castle Bravo", type: "bomb", short:'+1', hint: "Castle Bravo", cooldown:0, cooldownPeriod:100, inUse:false, help:'Les joueurs ayant des votes pairs sont révélés', log:'log text', targetMax:0, targetNoSelf:false,  targets:[], available:false, pos:10},
